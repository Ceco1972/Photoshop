...
namespace PhotoContest.DataBase.Migrations
{
    ...
    [Migration("20220618101509_Initial Migrate to re-create DB")]
    partial class InitialMigratetorecreateDB
    {
            ...
            modelBuilder.Entity("PhotoContest.Models.Models.Picture", b =>
                {
                    ...
                    b.HasOne("PhotoContest.Models.Models.Vote", "Vote")
                        .WithOne("Picture")
                        .HasForeignKey("PhotoContest.Models.Models.Picture", "VoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
